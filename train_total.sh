...
python3 inference.py model_name=CustomLGBMRegressor exp_name=lgbm_regressor_pretrain model_path=/home/user/work/CMI2024/Git/src/results/lgbm_regressor_pretrain/total_models.pkl phase=train
